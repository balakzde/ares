...
package cz.mfcr.wwwinfo.ares.xml_doc.schemas.ares.ares_answer_or.v_1_0;
 ...
 *       &lt;sequence>
 *         &lt;element name="Odpoved" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2}odpoved_OR" maxOccurs="unbounded"/>
 ...
 *       &lt;attribute name="odpoved_typ" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2}ares_dotaz_typ" fixed="Vypis_OR" />
...
@XmlRootElement(name = "Ares_odpovedi")
public class AresOdpovedi {

    @XmlElement(name = "Odpoved", required = true)
    protected List<OdpovedOR> odpoved;
     ...
     * 
     */
    public List<OdpovedOR> getOdpoved() {
        if (odpoved == null) {
            odpoved = new ArrayList<OdpovedOR>();
        }
        return this.odpoved;
    }
