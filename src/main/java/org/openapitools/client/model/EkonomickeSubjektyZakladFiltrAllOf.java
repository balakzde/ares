...
public class EkonomickeSubjektyZakladFiltrAllOf {
  ...
  public EkonomickeSubjektyZakladFiltrAllOf ico(List<String> ico) {
    
    this.ico = ico;
    return this;
  }

  public EkonomickeSubjektyZakladFiltrAllOf addIcoItem(String icoItem) {
    if (this.ico == null) {
  ...
  **/
  ...
  public EkonomickeSubjektyZakladFiltrAllOf obchodniJmeno(String obchodniJmeno) {
  ...
  **/
  ...
  public EkonomickeSubjektyZakladFiltrAllOf sidlo(AdresaFiltr sidlo) {
  ...
  **/
  ...
  public EkonomickeSubjektyZakladFiltrAllOf pravniForma(List<String> pravniForma) {
    
    this.pravniForma = pravniForma;
    return this;
  }

  public EkonomickeSubjektyZakladFiltrAllOf addPravniFormaItem(String pravniFormaItem) {
  ...
  **/
  ...
  public EkonomickeSubjektyZakladFiltrAllOf financniUrad(List<String> financniUrad) {
    
    this.financniUrad = financniUrad;
    return this;
  }

  public EkonomickeSubjektyZakladFiltrAllOf addFinancniUradItem(String financniUradItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EkonomickeSubjektyZakladFiltrAllOf ekonomickeSubjektyZakladFiltrAllOf = (EkonomickeSubjektyZakladFiltrAllOf) o;
    return Objects.equals(this.ico, ekonomickeSubjektyZakladFiltrAllOf.ico) &&
        Objects.equals(this.obchodniJmeno, ekonomickeSubjektyZakladFiltrAllOf.obchodniJmeno) &&
        Objects.equals(this.sidlo, ekonomickeSubjektyZakladFiltrAllOf.sidlo) &&
        Objects.equals(this.pravniForma, ekonomickeSubjektyZakladFiltrAllOf.pravniForma) &&
        Objects.equals(this.financniUrad, ekonomickeSubjektyZakladFiltrAllOf.financniUrad);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ico, obchodniJmeno, sidlo, pravniForma, financniUrad);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EkonomickeSubjektyZakladFiltrAllOf {\n");
