 ...
 */
@JsonPropertyOrder({
  AdresaRcns.JSON_PROPERTY_KOD_STATU,
  AdresaRcns.JSON_PROPERTY_NAZEV_STATU,
  AdresaRcns.JSON_PROPERTY_KOD_KRAJE,
  AdresaRcns.JSON_PROPERTY_NAZEV_KRAJE,
  AdresaRcns.JSON_PROPERTY_KOD_OKRESU,
  AdresaRcns.JSON_PROPERTY_NAZEV_OKRESU,
  AdresaRcns.JSON_PROPERTY_KOD_OBCE,
  AdresaRcns.JSON_PROPERTY_NAZEV_OBCE,
  AdresaRcns.JSON_PROPERTY_KOD_SPRAVNIHO_OBVODU,
  AdresaRcns.JSON_PROPERTY_NAZEV_SPRAVNIHO_OBVODU,
  AdresaRcns.JSON_PROPERTY_KOD_MESTSKEHO_OBVODU,
  AdresaRcns.JSON_PROPERTY_NAZEV_MESTSKEHO_OBVODU,
  AdresaRcns.JSON_PROPERTY_KOD_MESTSKE_CASTI_OBVODU,
  AdresaRcns.JSON_PROPERTY_KOD_ULICE,
  AdresaRcns.JSON_PROPERTY_NAZEV_MESTSKE_CASTI_OBVODU,
  AdresaRcns.JSON_PROPERTY_NAZEV_ULICE,
  AdresaRcns.JSON_PROPERTY_CISLO_DOMOVNI,
  AdresaRcns.JSON_PROPERTY_DOPLNEK_ADRESY,
  AdresaRcns.JSON_PROPERTY_KOD_CASTI_OBCE,
  AdresaRcns.JSON_PROPERTY_CISLO_ORIENTACNI,
  AdresaRcns.JSON_PROPERTY_CISLO_ORIENTACNI_PISMENO,
  AdresaRcns.JSON_PROPERTY_NAZEV_CASTI_OBCE,
  AdresaRcns.JSON_PROPERTY_KOD_ADRESNIHO_MISTA,
  AdresaRcns.JSON_PROPERTY_PSC,
  AdresaRcns.JSON_PROPERTY_TEXTOVA_ADRESA,
  AdresaRcns.JSON_PROPERTY_CISLO_DO_ADRESY,
  AdresaRcns.JSON_PROPERTY_TYP_CISLO_DOMOVNI,
  AdresaRcns.JSON_PROPERTY_STANDARDIZACE_ADRESY,
  AdresaRcns.JSON_PROPERTY_PSC_TXT,
  AdresaRcns.JSON_PROPERTY_PLATNOST_OD,
  AdresaRcns.JSON_PROPERTY_PLATNOST_DO,
  AdresaRcns.JSON_PROPERTY_TYP_ADRESY
})
