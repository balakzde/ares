...
public class DatumVr {
  ...
  private Date hodnota;

  public DatumVr() {
  }

  public DatumVr datumZapisu(Date datumZapisu) {
  ...
  **/
  ...
  public DatumVr datumVymazu(Date datumVymazu) {
  ...
  **/
  ...
  public DatumVr hodnota(Date hodnota) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_HODNOTA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHodnota(Date hodnota) {
    this.hodnota = hodnota;
  }
