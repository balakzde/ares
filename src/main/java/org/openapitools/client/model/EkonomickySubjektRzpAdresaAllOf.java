 ...
 */
@JsonPropertyOrder({
  EkonomickySubjektRzpAdresaAllOf.JSON_PROPERTY_PLATNOST_OD,
  EkonomickySubjektRzpAdresaAllOf.JSON_PROPERTY_PLATNOST_DO,
  EkonomickySubjektRzpAdresaAllOf.JSON_PROPERTY_TYP_ADRESY
})
@JsonTypeName("EkonomickySubjektRzpAdresa_allOf")
