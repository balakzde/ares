 ...
 */
@JsonPropertyOrder({
  AdresaRcnsAllOf.JSON_PROPERTY_PLATNOST_OD,
  AdresaRcnsAllOf.JSON_PROPERTY_PLATNOST_DO,
  AdresaRcnsAllOf.JSON_PROPERTY_TYP_ADRESY
})
@JsonTypeName("AdresaRcns_allOf")
...
public class AdresaRcnsAllOf {
  ...
  public AdresaRcnsAllOf platnostOd(Date platnostOd) {
  ...
  **/
  ...
  public AdresaRcnsAllOf platnostDo(Date platnostDo) {
